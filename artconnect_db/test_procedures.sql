...
INSERT INTO Reviews(rating, comment, review_date, artwork_id, member_id)
VALUES (5, 'Excellent', '2026-04-07', 1, 1);

INSERT INTO Exhibitions(title, end_date, description, curator_name, start_date, theme, gallery_id)
